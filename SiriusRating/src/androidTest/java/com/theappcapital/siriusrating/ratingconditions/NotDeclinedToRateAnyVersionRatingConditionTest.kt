...
class NotDeclinedToRateAnyVersionRatingConditionTest {
    ...
    fun test_condition_is_not_satisfied_when_the_max_amount_of_recurring_prompts_was_reached() {
        ...
        val notDeclinedToRateAnyVersionRatingCondition = NotDeclinedToRateAnyVersionRatingCondition(daysAfterDecliningToPromptUserAgain = 10u, maxRecurringPromptsAfterDeclining = 2u)
