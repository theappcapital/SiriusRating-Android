...
class StyleOneRequestPromptPresenter(
    ...
    private fun appIconDrawable(activity: Activity): Drawable? {
        return try {
    ...
    @SuppressLint("InflateParams") // Dialog content has no parent at inflate time.
    override fun show(
        activity: Activity,
        ...
        val appIcon = appIconDrawable(activity)
        ...
        appIconImageView.visibility = if (appIcon != null) View.VISIBLE else View.GONE
